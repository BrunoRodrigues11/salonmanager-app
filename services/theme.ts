...
export type ThemeColor = 'indigo' | 'rose' | 'blue' | 'emerald' | 'violet' | 'orange';
...
const STORAGE_KEY = 'salon_theme_color';

export const themeService = {
  getSavedTheme: (): ThemeColor => {
    return (localStorage.getItem(STORAGE_KEY) as ThemeColor) || 'indigo';
  },
  ...
  getAvailableColors: () => Object.keys(PALETTES) as ThemeColor[]
};
